...
Page({
  ...
  async getRecentlyPlay() {
    ...
    this.setData({
      poster: this.data.recentlyList[0].picUrl,
      name: this.data.recentlyList[0].name,
      author: this.data.recentlyList[0].singer,
      src: this.data.recentlyList[0].src
    })
  },
  play(e) {
    this.setData({
  ...
  previous() {
    if (this.data.index1 === 0) {
      this.setData({
        index1: this.data.songs.length - 1
      })
    } else {
      this.setData({
  ...
  next() {
    if (this.data.index1 === this.data.songs.length - 1) {
      this.setData({
        index1: 0
      })
    } else {
